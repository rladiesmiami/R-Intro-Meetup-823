...
- separation operators: (;,) eg. read.csv(file = 'test.csv' ,sep = ''); View(test.csv)

- algebraic operators: (+,-,*,/) are used for mathematical operations eg. 5+7

- TAB: Can be used to search functions and arguments eg. read.csv(TAB). Other than that NO semantic meaning e.g scope)
...
- (<-) Is not commutative (2 <- a not allowed ;  a <- 2 == 2 -> a)

- (=) Commutative ( a = 2; 2 = a  not allowed)
...
- character - Strings (categorical variables) eg. 'helloworld'
...
- factor - discrete value (categorical/ordinal variable - values of a category) eg. 'good', 'better', 'best','blue'
